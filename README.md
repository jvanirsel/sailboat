...
This allows for proper linting of the GEMINI source code, as well as the prebuilt modules contained in any of the `include` directories. Keep in mind that this requires GEMINI to have configured its build environment, i.e. `cmake -B build`. If you prefer, you can also directly edit `settings.json`. Here are example settings:
```json
"fortran.fortls.path": "/home2/vanirsej/.venvs/gemini/bin/fortls",
"fortran.linter.includePaths": [
    "/home2/vanirsej/gemini/gemini3d/build/**/include",
    "/home2/vanirsej/gemini/gemini3d/src"
],
```
